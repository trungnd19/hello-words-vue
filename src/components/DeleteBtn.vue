...
const emits = defineEmits(["deleteWord"]);

const { removeWordFromFavourite } = useFavourite();

function deleteWord() {
  const dialog = confirm("Are you sure you want to delete this word?");

  if (dialog) {
    removeWordFromFavourite(props.selectedWord);
    emits("deleteWord");
  }
}
</script>
